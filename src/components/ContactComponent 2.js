                    ...
                    <div className="col-12 col-md-9">
                        ...
                        <FormGroup row>
                            ...
                            <FormGroup className="row">
                                <Col className="col-md-6" md={{offset: 2}}>
                                    <FormGroup check>
                                        <Label check>
                                ...
                                <Col className="col-md-3" md={{offset: 1}}>
                            ...
                            <FormGroup row>
                                ...
                                <Col md={10}>
                                    <Input type='text-area' id="message" name='message' rows='12' value={this.state.message} onChange={this.handleInputChange} />
                                </Col>
                            </FormGroup>
                            <FormGroup row>
                                <Col md={{size:10, offset: 2}}>
                                    <Button type='sumbit' color='primary'>Send Feedback</Button>
                                </Col>
                            </FormGroup>
                        </Form>
                    </div>
